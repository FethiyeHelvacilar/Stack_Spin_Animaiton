...
def set_scene_props(fps, loop_seconds):
    ...
    world = bpy.data.worlds["World"].node_tree.nodes["Background"].inputs[0].default_value = (0, 0, 0, 1)
...
def setup_scene(i=0):
    ...
    bpy.context.scene.render.filepath = f"/tmp/project_{project_name}/loop_{i}.png"
...
def add_lights():
    rotation = (math.radians(0), 0.0, math.radians(180))
